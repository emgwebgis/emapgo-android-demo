...
public class MapStyleRainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView.setStyleUrl("http://111.203.245.107:10003/styles/rain/style.json");
