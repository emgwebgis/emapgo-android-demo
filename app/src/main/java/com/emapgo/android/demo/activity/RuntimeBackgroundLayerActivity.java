...
import com.emapgo.mapsdk.style.layers.BackgroundLayer;
import com.emapgo.mapsdk.style.layers.PropertyFactory;

public class RuntimeBackgroundLayerActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_runtime_background_layer);
    ...
    public void onMapReady(EmgMap emgMap) {
        ...
        backgroundLayer.setProperties(
                //PropertyFactory.backgroundColor(Color.BLUE) //背景颜色
                 PropertyFactory.backgroundPattern("pedestrian-polygon")
        );
        //添加图层
        emgMap.addLayer(backgroundLayer);
    }
