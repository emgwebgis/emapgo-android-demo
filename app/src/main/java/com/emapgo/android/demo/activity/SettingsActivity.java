...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || NavigationPreferences.class.getName().equals(fragmentName);
    }
    ...
    public static class MapPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("route_service_key"));
            bindPreferenceSummaryToValue(findPreference("emapgo_service_key"));
            bindPreferenceSummaryToValue(findPreference("source_url_key"));
        }
    ...
    public static class NavigationPreferences extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            //bindPreferenceSummaryToValue(findPreference("auto_navigation_key"));
